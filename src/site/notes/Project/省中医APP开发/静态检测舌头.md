---
{"tags":["Project/AndroidStudio","Project/省中医APP开发"],"dg-publish":true,"permalink":"/Project/省中医APP开发/静态检测舌头/","dgPassFrontmatter":true}
---
...
2. [[Project/省中医APP开发/Android部署检测模型\|Android部署检测模型]]